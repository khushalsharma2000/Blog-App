...
const CreatePost = () => {
    ...
    const handleCreate = async (e) => {
        ...
        if (file) {
            ...
            try {
                ...
                await axios.post(URL + "/api/upload", data, { headers: headers });
            } catch (err) {
                console.log(err);
            }
        }
        ...
        try {
            ...
            const res = await axios.post(URL + "/api/posts/create", post, { headers: headers });
    ...
    return (
        <div>
            <Navbar />
            <div className='px-6 md:px-[200px] mt-8  bg-orange-400'>
                ...
                <form className='w-full flex flex-col space-y-4 md:space-y-8 mt-4'>
                    ...
                    <textarea onChange={(e) => setDesc(e.target.value)} rows={15} cols={30} className='px-4 py-0 outline-none' placeholder='Enter post description' />
